...
//                }
    ...
    public JedisPool jedisPool(JedisPoolConfig jedisPoolConfig) {
        ...
        JedisPool jedisPool = new JedisPool(jedisPoolConfig, redisConfigurationProperties.getHost(), redisConfigurationProperties.getPort(), 0, redisConfigurationProperties.getPassword());
...
//    @Bean
//    public ExtendedRedisCacheManager cacheManager(StringRedisTemplate stringRedisTemplate) {
//        RedisCachePrefix cachePrefix = new DefaultRedisCachePrefix();
//
//        ExtendedRedisCacheManager cacheManager = new ExtendedRedisCacheManager(stringRedisTemplate);
