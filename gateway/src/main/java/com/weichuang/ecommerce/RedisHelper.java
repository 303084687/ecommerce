...
public class RedisHelper {
    ...
    public static final String TYPE_BIND = "bind"; // 登录
...
//	JedisCluster jedisCluster;
    ...
    public String setDictionary(String redisType, String key, String value) {
        ...
        //注册
        if (redisType.equals(TYPE_VERIFICATION) || redisType.equals(TYPE_BIND)) {
            time = 60 * 60L; // 1小时后超时
        }
        //设备登录
        if (redisType.equals(TYPE_IMMEREX_TOKEN)) {
            time = 24 * 60 * 60L; // 1天后超时
        }
     ...
     * <p>return </p>
     */
    public String setSession(String redisType, String key, String value) {
        // nxxx的值只能取NX或者XX，如果取NX，则只有当key不存在是才进行set，如果取XX，则只有当key已经存在时才进行set
        //的值只能取EX或者PX，代表数据过期时间的单位，EX代表秒，PX代表毫秒。
        String result;
    ...
    /**
     * <p>Description: 向redis中添加token</p>
     * <p>param </p>
     * <p>author zhouhe </p>
     * <p>date 2017/5/23 16:22 </p>
     * <p>return </p>
     */
