...
public enum Result {
    ...
    //抽奖
    ILLEGAL_TICKET_EXCEPTION(20035, "无效抽奖票据凭证"),
    USED_TICKET_EXCEPTION(20036, "抽奖票据凭证已使用"),
    PRAISE_CASH_EXCEPTION(20037, "兑奖失败"),
    PRAISE_CASH_REPEAT_EXCEPTION(20038, "重复兑换"),
    PRAISE_ACTIVITY_ILLEGAL_EXCEPTION(20039, "无效的抽奖活动"),
    PRAISE_ACTIVITY_EXPIRED_EXCEPTION(20040, "抽奖活动尚未开始或已经结束"),
    PRAISE_CHANCE_NULL_EXCEPTION(20041, "您今天的抽奖机会已经用尽了"),
