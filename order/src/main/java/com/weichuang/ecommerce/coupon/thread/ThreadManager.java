...
/**
 * <p>ClassName: TaskManager.java</p>
 * <p>Company: 伟创科技(北京)科技有限公司</p>
 * <p>Description:线程分配 </p>
 * <p>author wanggongliang</p>
 * <p>2017年12月15日 下午2:08:33</p>
 */
public class ThreadManager {
    ...
    public static List[] distributeTasks(List taskList, int threadCount) {
         ...
         * + " 区间[" + ((Coupon) taskListPerThread[i].get(0)).getUserId() + "," +
         * ((Coupon) taskListPerThread[i].get(taskListPerThread[i].size() -
         * 1)).getUserId() + "]"); }
         */
