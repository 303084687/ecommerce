 ...
 */
public class SalesWithdrawInfoEntity implements Serializable {
    ...
    private String withdrawString;//提现总金额

    public String getWithdrawString() {
    ...
    public void setWithdraw(BigDecimal withdraw) {
        ...
        withdrawString=withdraw.toString();
    }
