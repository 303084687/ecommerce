...
import com.weichuang.ecommerce.weixinPay.api.WxPayApiConfigKit;
...
public class PaymentKit {
    ...
    public static Map<String, String> prepayIdCreateSign(String prepay_id) {
        ...
        String packageSign = PaymentKit.createSign(packageParams, WxPayApiConfigKit.getWxPayApiConfig()
                .getPaternerKey());
