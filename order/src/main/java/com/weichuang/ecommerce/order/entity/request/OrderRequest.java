...
/**
 * <p>ClassName: OrderRequest</p>
 * <p>Company: 伟业创投(北京)科技有限公司   http://www.weichuangwuxian.cn</p>
 * <p>Description: 订单数据请求</p>
...
public class OrderRequest {
    ...
    private int sendTimes; //需要配送的次数（需要发货的次数）
    private String remark;//买家留言
    private List<OrderDetailRequest> orderDetails;//订单详情
    private OrderRecevierRequest orderRecevier;//订单收货详情（创建订单的情况下默认一个收货人地址）
    ...
    public OrderRecevierRequest getOrderRecevier() {
        return orderRecevier;
    }

    public void setOrderRecevier(OrderRecevierRequest orderRecevier) {
