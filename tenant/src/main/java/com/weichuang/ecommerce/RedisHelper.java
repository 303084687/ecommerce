...
public class RedisHelper {
    ...
    public static final String TYPE_ACCESSTOKEN = "accessToken";// 公众号access_token
    ...
    public String setDictionary(String redisType, String key, String value) {
        ...
        if (redisType.equals(TYPE_ACCESSTOKEN)) {
            time = 60 * 60L; // 一小时后过期
        }
        if (redisType.equals(TYPE_BIND) || redisType.equals(TYPE_REGISTER)) {
            time = 30 * 60L; // 半小时后过期
        }
