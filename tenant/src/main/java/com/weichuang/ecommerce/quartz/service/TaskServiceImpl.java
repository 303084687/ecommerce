package com.weichuang.ecommerce.quartz.service;
...
import com.weichuang.ecommerce.quartz.common.exception.ServiceException;
import com.weichuang.ecommerce.quartz.domain.TaskInfo;
...
public class TaskServiceImpl {
    ...
    public void addJob(TaskInfo info) {
        String jobName = info.getJobName(), jobGroup = info.getJobGroup(), cronExpression = info.getCronExpression(), jobDescription = info
                .getJobDescription(), createTime = DateFormatUtils.format(new Date(), "yyyy-MM-dd HH:mm:ss");
        try {
